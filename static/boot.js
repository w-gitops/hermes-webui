...
(function(){
  ...
  function _speakResponse(){
    ...
    // Chatterbox TTS via the fork's shared streaming helper (chunked + sequential;
    // defined in _HERMES_TTS_JS). Preferred when wired: sending the whole turn as one
    // request blew past the server timeout on long replies (Chatterbox is ~70ms/char)
    // -> 502 -> silence. Falls through to the stock engine dispatch when absent.
